...
In this case, variable1 = temperature, dimension1 = latitude, dimension2 = longitude, dimension3 = depth, and its varying through time (which is the unlimited dimension -- e.g. you can add additional timesteps). Again, you could have additional variables with the same dimensions. 
...
### Variables 
 ...
 A variable is an array that stores the actual data (e.g. temperature, salinity, etc). Each variable has a name, data type and is defined by one or more dimensions.
